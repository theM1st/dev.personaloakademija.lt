...
abstract class AdminController extends Controller
{
    ...
    {
        $this->createFlash($class, $request, $imageColumn);
    ...
    {
        $this->saveFlash($model, $request, $imageColumn);
        return $this->redirectRoutePath($path);
    }

    public function createFlash($class, $request, $imageColumn = false)
    {
    ...
    public function saveFlash($model, $request, $imageColumn = false)
    {
     ...
     */
    public function viewPath($path = 'index', $data = [])
    {
    ...
    protected function uploadAndGetPath(UploadedFile $file)
    {
        ...
        list($host, $uploadPath) = explode(DIRECTORY_SEPARATOR.'public'.DIRECTORY_SEPARATOR, $fullPath);
        return $uploadPath;
    }
