    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <td>Darbas</td>
                <td>Praktika</td>
                <td>Darbas (archyvas)</td>
                <td>Praktika (archyvas)</td>
            </tr>
        </thead>
        <tbody>
            @foreach ($companies as $c)
                <tr>
                    ...
                    <td>{{$c->offers()->jobs()->valid()->count()}}</td>
                    <td>{{$c->offers()->practices()->valid()->count()}}</td>
                    <td>{{$c->offers()->jobs()->archived()->count()}}</td>
                    <td>{{$c->offers()->practices()->archived()->count()}}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
